...
const transformData = (stats: FinalStats[]): ChartDataPoint[] => {
    ...
    return [
        {
            month: "2021",
            [playerOneName]: stats?.[0]?.playerOneStats?.nflverse_play_by_play_2021?.fantasyPoints ?? 0,
            [playerTwoName]: stats?.[0]?.playerTwoStats?.nflverse_play_by_play_2021?.fantasyPoints ?? 0,
            playerOneName: undefined,
            playerTwoName: undefined
        },
        {
            month: "2022",
            [playerOneName]: stats?.[0]?.playerOneStats?.nflverse_play_by_play_2022?.fantasyPoints ?? 0,
            [playerTwoName]: stats?.[0]?.playerTwoStats?.nflverse_play_by_play_2022?.fantasyPoints ?? 0,
            playerOneName: undefined,
            playerTwoName: undefined
        },
        {
            month: "2023",
            [playerOneName]: stats?.[0]?.playerOneStats?.nflverse_play_by_play_2023?.fantasyPoints ?? 0,
            [playerTwoName]: stats?.[0]?.playerTwoStats?.nflverse_play_by_play_2023?.fantasyPoints ?? 0,
            playerOneName: undefined,
            playerTwoName: undefined
        },
    ]
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center gap-2 leading-none text-gray-700">
                            ...
                            >
                                ...
                                <span>
                                    {renderTrend(
                                        stats?.[0]?.playerOneStats?.nflverse_play_by_play_2022?.fantasyPoints ?? 0,
                                        stats?.[0]?.playerOneStats?.nflverse_play_by_play_2023?.fantasyPoints ?? 0
                                    )}
                                </span>
                            </span>{" "}
                            and{" "}
                            ...
                            >
                                ...
                                <span>
                                    {renderTrend(
                                        stats?.[0]?.playerTwoStats?.nflverse_play_by_play_2022?.fantasyPoints ?? 0,
                                        stats?.[0]?.playerTwoStats?.nflverse_play_by_play_2023?.fantasyPoints ?? 0
                                    )}
                                </span>
                            </span>
                        </div>
