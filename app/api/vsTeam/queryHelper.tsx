...
// Function to create SQL query for getting player stats against a specific team and year
export function createSqlQueryVsTeam(
  playerGsis: string,
  team: string,
  year: string
) {
  return Prisma.sql`
    SELECT
        ...
        (SELECT SUM("interception")
         ...
         AND "season_type" = 'REG'
         AND "defteam" = ${team}) AS total_interceptions
    FROM ${Prisma.raw(`"${year}"`)}
